...
title: "Build plugins – Codex | OpenAI Developers"
crawledAt: 2026-04-27T13:55:33.381Z
---
...
![plugin-creator skill in Codex](https://developers.openai.com/images/codex/plugins/plugin-creator.png)![plugin-creator skill in Codex](https://developers.openai.com/images/codex/plugins/plugin-creator-dark.png)
...
![how to invoke the plugin-creator skill](https://developers.openai.com/images/codex/plugins/plugin-creator-invoke.png)![how to invoke the plugin-creator skill](https://developers.openai.com/images/codex/plugins/plugin-creator-invoke-dark.png)
...
![custom local marketplace in the plugin directory](https://developers.openai.com/images/codex/plugins/codex-local-plugin-light.png)![custom local marketplace in the plugin directory](https://developers.openai.com/images/codex/plugins/codex-local-plugin.png)
...
follow [Build your own curated plugin list](https://developers.openai.com/codex/plugins/build#build-your-own-curated-plugin-list)
...
[Marketplace metadata](https://developers.openai.com/codex/plugins/build#marketplace-metadata) for the file format.
