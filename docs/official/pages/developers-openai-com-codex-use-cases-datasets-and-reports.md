...
crawledAt: 2026-04-27T14:11:04.451Z
---
...
[Agent skills](https://developers.openai.com/codex/skills) [Worktrees in the Codex app](https://developers.openai.com/codex/app/worktrees)
...
| Skill | Why use it |
| --- | --- |
| [Spreadsheet](https://github.com/openai/skills/tree/main/skills/.curated/spreadsheet) | Inspect CSV, TSV, and Excel files when formulas, exports, or quick spreadsheet checks matter. |
...
\\
Integrations  Data](https://developers.openai.com/codex/use-cases/new-hire-onboarding) [![](https://developers.openai.com/images/codex/codex-wallpaper-1.webp)\\
\\
**Query tabular data**\\
\\
Use Codex with a CSV, spreadsheet, dashboard export, Google Sheet, or local data file to... \\
\\
Data  Knowledge Work](https://developers.openai.com/codex/use-cases/analyze-data-export) [![](https://developers.openai.com/images/codex/codex-wallpaper-3.webp)\\
\\
