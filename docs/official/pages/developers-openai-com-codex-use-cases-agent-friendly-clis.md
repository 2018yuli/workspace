...
crawledAt: 2026-04-27T14:07:22.239Z
---
...
[Codex skills](https://developers.openai.com/codex/skills) [Create custom skills](https://developers.openai.com/codex/skills/create-skill)
...
1. [Decide whether the job needs a CLI](https://developers.openai.com/codex/use-cases/agent-friendly-clis#choose-what-the-cli-should-do)
2. [Share the source Codex should learn from](https://developers.openai.com/codex/use-cases/agent-friendly-clis#share-the-docs-files-or-commands)
3. [Run `$cli-creator`](https://developers.openai.com/codex/use-cases/agent-friendly-clis#ask-codex-to-build-the-cli-and-skill)
4. [Test the installed command](https://developers.openai.com/codex/use-cases/agent-friendly-clis#verify-the-command-works-from-any-folder)
5. [Invoke the saved skill later](https://developers.openai.com/codex/use-cases/agent-friendly-clis#use-the-skill-later)
...
\\
Front-end  Integrations](https://developers.openai.com/codex/use-cases/deploy-app-or-website) [![](https://developers.openai.com/images/codex/codex-wallpaper-2.webp)\\
\\
**Refactor your codebase**\\
\\
Use Codex to remove dead code, untangle large files, collapse duplicated logic, and... \\
\\
Engineering  Code](https://developers.openai.com/codex/use-cases/refactor-your-codebase)
