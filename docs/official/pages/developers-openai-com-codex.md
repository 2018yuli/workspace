...
crawledAt: 2026-04-27T12:59:50.262Z
---
...
[Get started with Codex](https://developers.openai.com/codex/quickstart)

[**Quickstart**\\
\\
Download and start building with Codex. \\
\\
Get started](https://developers.openai.com/codex/quickstart) [**Explore use cases**\\
\\
Get inspiration on what you can build with Codex. \\
\\
Learn more](https://developers.openai.com/codex/use-cases) [**Community**\\
\\
Read community posts, explore meetups, and connect with Codex builders. \\
\\
See community](https://developers.openai.com/community) [**Codex for Open Source**\\
\\
