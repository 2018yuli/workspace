...
sub implementation_refs_for_text {
    ...
    my @rules = (
        [
            ...
            [
                md_link('Codex', '/codex/codex-rs/core/src/codex.rs:285'),
                md_link('CodexThread', '/codex/codex-rs/core/src/codex_thread.rs:37'),
                md_link('ThreadManager::fork_thread', '/codex/codex-rs/core/src/thread_manager.rs:375'),
                md_link('agent/control', '/codex/codex-rs/core/src/agent/control.rs:1'),
                md_link('spawn.rs', '/codex/codex-rs/core/src/spawn.rs:1'),
                md_link('StateRuntime::create_agent_job', '/codex/codex-rs/state/src/runtime.rs:917'),
            ],
        ],
        [
            ...
            [
                md_link('CodexThread', '/codex/codex-rs/core/src/codex_thread.rs:37'),
                md_link('ThreadManager', '/codex/codex-rs/core/src/thread_manager.rs:120'),
                md_link('context_manager', '/codex/codex-rs/core/src/context_manager/mod.rs:1'),
                md_link('message_history', '/codex/codex-rs/core/src/message_history.rs:1'),
                md_link('rollout/mod', '/codex/codex-rs/core/src/rollout/mod.rs:1'),
                md_link('StateRuntime::list_threads', '/codex/codex-rs/state/src/runtime.rs:306'),
            ],
        ],
        [
            qr/沙盒|审批|权限|网络访问|read-only|workspace-write|danger-full-access|批准/i,
            [
                md_link('sandboxing/mod', '/codex/codex-rs/core/src/sandboxing/mod.rs:38'),
                md_link('SandboxManager', '/codex/codex-rs/core/src/sandboxing/mod.rs:291'),
                md_link('config/permissions', '/codex/codex-rs/core/src/config/permissions.rs:9'),
                md_link('linux-sandbox', '/codex/codex-rs/linux-sandbox/src/lib.rs:18'),
                md_link('linux_run_main', '/codex/codex-rs/linux-sandbox/src/linux_run_main.rs:76'),
                md_link('windows-sandbox', '/codex/codex-rs/windows-sandbox-rs/src/lib.rs:240'),
                md_link('request_command_approval', '/codex/codex-rs/core/src/codex.rs:2576'),
                md_link('request_patch_approval', '/codex/codex-rs/core/src/codex.rs:2637'),
            ],
        ],
        [
            qr/工具|tool|执行命令|shell|exec|apply_patch|write_stdin/i,
            [
                md_link('tools/orchestrator', '/codex/codex-rs/core/src/tools/orchestrator.rs:43'),
                md_link('tools/router', '/codex/codex-rs/core/src/tools/router.rs:1'),
                md_link('tools/registry', '/codex/codex-rs/core/src/tools/registry.rs:1'),
                md_link('unified_exec/mod', '/codex/codex-rs/core/src/unified_exec/mod.rs:74'),
                md_link('exec crate', '/codex/codex-rs/exec/src/lib.rs:1'),
                md_link('apply_patch bridge', '/codex/codex-rs/core/src/apply_patch.rs:1'),
                md_link('shell-command', '/codex/codex-rs/shell-command/src/lib.rs:1'),
            ],
        ],
        [
            qr/技能|skill|SKILL|技能脚本/i,
            [
                md_link('SkillsManager', '/codex/codex-rs/core/src/skills/manager.rs:26'),
                md_link('skills/loader', '/codex/codex-rs/core/src/skills/loader.rs:1'),
                md_link('skills/injection', '/codex/codex-rs/core/src/skills/injection.rs:1'),
                md_link('skills/permissions', '/codex/codex-rs/core/src/skills/permissions.rs:1'),
                md_link('skills crate', '/codex/codex-rs/skills/src/lib.rs:1'),
            ],
        ],
        [
            qr/MCP|资源模板|resource|工具服务器|server/i,
            [
                md_link('mcp_connection_manager', '/codex/codex-rs/core/src/mcp_connection_manager.rs:546'),
                md_link('mcp_tool_call', '/codex/codex-rs/core/src/mcp_tool_call.rs:1'),
                md_link('core/mcp/mod', '/codex/codex-rs/core/src/mcp/mod.rs:1'),
                md_link('mcp-server/lib', '/codex/codex-rs/mcp-server/src/lib.rs:51'),
                md_link('codex_tool_runner', '/codex/codex-rs/mcp-server/src/codex_tool_runner.rs:59'),
            ],
        ],
        [
            qr/记忆|编年史|memories|长期上下文/i,
            [
                md_link('memories/mod', '/codex/codex-rs/core/src/memories/mod.rs:1'),
                md_link('memories/storage', '/codex/codex-rs/core/src/memories/storage.rs:1'),
                md_link('memories/phase1', '/codex/codex-rs/core/src/memories/phase1.rs:1'),
                md_link('memories/phase2', '/codex/codex-rs/core/src/memories/phase2.rs:1'),
                md_link('state runtime memories', '/codex/codex-rs/state/src/runtime/memories.rs:1'),
                md_link('state model memories', '/codex/codex-rs/state/src/model/memories.rs:1'),
            ],
        ],
        [
            qr/模型|推理|reasoning|model/i,
            [
                md_link('ModelsManager', '/codex/codex-rs/core/src/models_manager/manager.rs:55'),
                md_link('model_info', '/codex/codex-rs/core/src/models_manager/model_info.rs:1'),
                md_link('model_presets', '/codex/codex-rs/core/src/models_manager/model_presets.rs:1'),
                md_link('supported_models', '/codex/codex-rs/app-server/src/models.rs:10'),
            ],
        ],
        [
            qr/配置|config|toml|覆盖|requirements|约束/i,
            [
                md_link('config/state', '/codex/codex-rs/config/src/state.rs:118'),
                md_link('config/constraint', '/codex/codex-rs/config/src/constraint.rs:51'),
                md_link('config/config_requirements', '/codex/codex-rs/config/src/config_requirements.rs:78'),
                md_link('config/overrides', '/codex/codex-rs/config/src/overrides.rs:7'),
                md_link('config/diagnostics', '/codex/codex-rs/config/src/diagnostics.rs:36'),
                md_link('core/config/service', '/codex/codex-rs/core/src/config/service.rs:1'),
            ],
        ],
        [
            ...
            [
                md_link('StateRuntime::create_agent_job', '/codex/codex-rs/state/src/runtime.rs:917'),
                md_link('StateRuntime::report_agent_job_item_result', '/codex/codex-rs/state/src/runtime.rs:1337'),
                md_link('cloud-tasks App', '/codex/codex-rs/cloud-tasks/src/app.rs:47'),
                md_link('cloud-tasks CLI', '/codex/codex-rs/cloud-tasks/src/cli.rs:7'),
                md_link('cloud-tasks run_main', '/codex/codex-rs/cloud-tasks/src/lib.rs:732'),
            ],
        ],
        [
            qr/工作树|worktree|git/i,
            [
                md_link('git_info', '/codex/codex-rs/core/src/git_info.rs:1'),
                md_link('undo task', '/codex/codex-rs/core/src/tasks/undo.rs:1'),
                md_link('review prompts', '/codex/codex-rs/core/src/review_prompts.rs:22'),
                md_link('commit_attribution', '/codex/codex-rs/core/src/commit_attribution.rs:1'),
            ],
        ],
        [
            qr/应用|IDE|CLI|transport|websocket|消息处理|前端|桌面/i,
            [
                md_link('app-server run_main', '/codex/codex-rs/app-server/src/lib.rs:295'),
                md_link('CodexMessageProcessor', '/codex/codex-rs/app-server/src/codex_message_processor.rs:399'),
                md_link('transport', '/codex/codex-rs/app-server/src/transport.rs:73'),
                md_link('thread_state', '/codex/codex-rs/app-server/src/thread_state.rs:1'),
                md_link('codex-cli entry', '/codex/codex-cli/bin/codex.js:1'),
            ],
        ],
        [
            qr/审阅|review|代码审查/i,
            [
                md_link('review_prompts', '/codex/codex-rs/core/src/review_prompts.rs:22'),
                md_link('tasks/review', '/codex/codex-rs/core/src/tasks/review.rs:1'),
                md_link('app-server review tests', '/codex/codex-rs/app-server/tests/suite/v2/review.rs:1'),
            ],
        ],
        [
            qr/提示|prompts|自定义提示|AGENTS|项目文档/i,
            [
                md_link('custom_prompts', '/codex/codex-rs/core/src/custom_prompts.rs:9'),
                md_link('project_doc', '/codex/codex-rs/core/src/project_doc.rs:134'),
                md_link('instructions/user_instructions', '/codex/codex-rs/core/src/instructions/user_instructions.rs:1'),
            ],
        ],
        [
            qr/状态|持久化|数据库|日志|archive|归档/i,
            [
                md_link('StateRuntime', '/codex/codex-rs/state/src/runtime.rs:63'),
                md_link('log_db', '/codex/codex-rs/state/src/log_db.rs:47'),
                md_link('extract/apply_rollout_item', '/codex/codex-rs/state/src/extract.rs:15'),
                md_link('state_db', '/codex/codex-rs/core/src/state_db.rs:1'),
            ],
        ],
        [
            qr/钩子|hook|通知/i,
            [
                md_link('Hooks', '/codex/codex-rs/hooks/src/registry.rs:14'),
                md_link('Hook types', '/codex/codex-rs/hooks/src/types.rs:34'),
                md_link('user_notification', '/codex/codex-rs/hooks/src/user_notification.rs:31'),
            ],
        ],
        [
            qr/搜索|网页|internet|web search/i,
            [
                md_link('web_search', '/codex/codex-rs/core/src/web_search.rs:18'),
                md_link('network_policy_decision', '/codex/codex-rs/core/src/network_policy_decision.rs:1'),
                md_link('network-proxy', '/codex/codex-rs/network-proxy/src/lib.rs:1'),
            ],
        ],
        [
            qr/认证|登录|auth|api key/i,
            [
                md_link('auth', '/codex/codex-rs/core/src/auth.rs:1'),
                md_link('auth/storage', '/codex/codex-rs/core/src/auth/storage.rs:1'),
                md_link('login crate', '/codex/codex-rs/login/src/lib.rs:1'),
                md_link('cloud-tasks auth helper', '/codex/codex-rs/cloud-tasks/src/util.rs:62'),
            ],
        ],
    );
